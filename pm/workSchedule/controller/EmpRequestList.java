...
@Slf4j
@Controller
@RequestMapping("emp/requests")
public class EmpRequestList {
	...
	public String list(
		...
		List<HoliVO> reqList = sDAO.holiday_requestList(authForHoli.getEmpId());
		for(HoliVO holiVO : reqList) {
			log.info("휴가요청목록::::::{}", holiVO);			
		}
		model.addAttribute("reqList", reqList);
		
		return "admin/lej/pm/emp/requestList";
	}
