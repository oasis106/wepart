...
@Slf4j
@Controller
@RequestMapping("hr/workSchedule/insert")
public class WorkScheduleInsert {
	...
	public Map<String, String> insertWork(
		@Validated(InsertGroup.class) @ModelAttribute("schedule") ScheduleVO scVO
		, Errors errors
	) {
		log.info("스케쥴:::::::::::::{}", scVO);
		Map<String, String> errorMap = new HashMap<>();
		String retValue = null;
		String retMessage = "insert";
		if(!errors.hasErrors()) {
			// 에러 없음.
			ServiceResult result = scService.createWork(scVO);
			switch (result) {
			case OK:
				retValue = "success";
